...
export async function generateOpponentRebuttal({
  ...
  switch (persona) {
    case 'aggressive':
      personaPrompt = "You are the 'Aggressive BP Debater'. You aggressively attack the opponent's core mechanisms. You do not just disagree; you systematically dismantle their logic with high energy and sharp rhetoric."
      break
    case 'technical':
